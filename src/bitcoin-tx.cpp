...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s satcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  satcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded satcoin transaction") + "\n" +
              "  satcoin-tx [options] -create [commands]   " + _("Create hex-encoded satcoin transaction") + "\n" +
              "\n";
